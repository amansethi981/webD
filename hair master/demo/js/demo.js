jQuery(document).ready(function ($) {
    ...
    var themeName = 'ct_goodlooks.' + pathname;
    ...
    function store() {
        ...
        setCookie('ct_goodlooks', r);
    }

    function load() {
        d = getCookie('ct_goodlooks');
        if (d) {
...
function selectDropdown(){
    ...
    if (getCookie('ct_goodlooks.dropdown') != null) {
        jQuery('.navbar-nav').removeClass('ct-navbar--fadeIn');
        jQuery('.navbar-nav').removeClass(getCookie('ct_goodlooks.dropdown'));
    } else{
        jQuery('.navbar-nav').removeClass('ct-navbar--fadeIn');
    }
    ...
    setCookie('ct_goodlooks.dropdown', strUser);
